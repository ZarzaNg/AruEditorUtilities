...
protected:
	...
	template<typename T>
	const void* GetNewValueBySourceType(const UStruct* TypeToMatch = nullptr) const
	{
		...
		case EAruValueSource::Value:
			{
				...
				return PointerWrapper(Property, PropertyValue);
			}
		case EAruValueSource::Object:
			{
				...
				return PointerWrapper(PropertyContext.PropertyPtr, PropertyContext.ValuePtr);
			}
